...
Ext.ux.grid.ColumnHeaderGroup = Ext.extend(Ext.util.Observable, {
    ...
    init: function (grid) {
        ...
        Ext.apply(this.viewConfig, {
            onColumnWidthUpdated : view.onColumnWidthUpdated.createSequence(function () {
                Ext.ux.grid.ColumnHeaderGroup.prototype.updateGroupStyles.call(this);
            }),

            onAllColumnWidthsUpdated : view.onAllColumnWidthsUpdated.createSequence(function () {
                Ext.ux.grid.ColumnHeaderGroup.prototype.updateGroupStyles.call(this);
            }),

            onColumnHiddenUpdated : view.onColumnHiddenUpdated.createSequence(function () {
                Ext.ux.grid.ColumnHeaderGroup.prototype.updateGroupStyles.call(this);
            })       
        });
