...
Ext.ux.tree.TreeGrid = Ext.extend(Ext.net.TreePanel, {
    ...
    onRender : function () {
        ...
        this.updateColumnWidths.defer(1, this);
    },
    ...
    updateColumnWidths : function () {
        ...
        if (Ext.isChrome) {
            headerDivs = this.el.child('.x-grid3-header').query('div.x-grid3-hd-inner.x-treegrid-hd-inner');
        }
        ...
        for (i = 0; i<colCount; i++) {
            ...
            if (headerDivs) {
                headerDivs[i].style.width = (c.hidden ? 0 : c.width - 10) + 'px'; 
            }
        }
