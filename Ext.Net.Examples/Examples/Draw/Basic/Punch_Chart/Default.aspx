    ...
    <script type="text/javascript">
        function onMouseOver(surface, id){
            ...
            if (bg) {
                ...
                clr[1] = .5;
                dt._fill = dt.fill;
                dt.setAttributes({"fill" : Ext.draw.Color.fromHSL(clr[0], clr[1], clr[2]).toString()}, true);
            }
            lbl.show(true);
        }

        function onMouseOut(surface, id){
            var lbl = surface.items.get("lbl"+id),
                bg = surface.items.get("bg"+id),
                dt = surface.items.get("dt"+id);
            ...
            if (bg) {
                ...
                dt.setAttributes({"fill" : dt._fill}, true);
            }
            lbl.hide(true);
        }
    </script>
